    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('luu-du-an-b1') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group ">
                                ...
                                <div class="col-sm-12">
                                    <input class="form-control" type="text" value="{{ old('tieu_de') }}" name="tieu_de" id="example-text-input">
                                </div>
                            </div>
                            <div class="form-group ">
                                ...
                                <div class="col-sm-12">
                                    <textarea id="textarea" class="form-control" maxlength="225" rows="3"
                                        name="mo_ta_ngan">{{ old('mo_ta_ngan') }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input name="dia_chi" type="text" class="form-control" id="input-location"
                                        placeholder="Nhập địa chỉ trên bản đồ" value="{{ old('dia_chi') }}">
                                </div>
                                ...
                                <input name="latitude" type="text" value="{{ old('latitude') }}" class="form-control" id="latitude" hidden>
                                <input name="longitude" type="text" value="{{ old('longitude') }}"   class="form-control" id="longitude" hidden>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="anh-dai-dien">
                                <div class="image background-image-ss thubmnail">
                                    <img src="" alt="">
                                </div>
                                <div id="preview-thumb" class="single-file-input">
                                    <input type="file" required id="user_image" name="anh_dai_dien" value="{{ old('anh_dai_dien') }}" >
...
<script>
    ...
    var latitude = {{ old('latitude') ?old('latitude'):51.511971}};
    var longitude ={{ old('longitude') ?old('longitude'):51.511971}};
